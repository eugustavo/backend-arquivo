...
export function query_nfs_mod_57(empresa: any, estab: any, data1: any, data2: any) {
  ...
  const sql = `SELECT * FROM SIGRA_NFS_MODELO_57(${empresa}, ${estab}, '${converteData(data1)}', '${converteData(data2)}')`
